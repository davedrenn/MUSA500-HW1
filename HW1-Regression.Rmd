...
Second, we use T-test hypothesis testing to determine the significance of each of the four predictors ($β_1PCTVACANT$, $β_2PCTSINGLES$, $β_3PCTBACHMOR$, and $β_4LNNBELPOV100$) on our dependent variable LNMEDHVAL.
